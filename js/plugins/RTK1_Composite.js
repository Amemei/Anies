...
(function(_global) {
	...
	Window_CompositeStatus.prototype.refresh = function() {
		...
		if (item[NK]) {
			...
			this.drawText(item[NK].v1[2] + "/" + item[NK].v1[1], x * 1.7, y, 60, 'right');
			y += lineHeight;
			this.changePaintOpacity(true);
			...
			if (item[NK].v2) {
				...
				this.drawText(item[NK].v2[2] + "/" + item[NK].v2[1], x * 1.7, y, 60, 'right');
				this.changePaintOpacity(true);
			}
			y += lineHeight;
			...
			if (item[NK].v3) {
				...
				this.drawText(item[NK].v3[2] + "/" + item[NK].v3[1], x * 1.7, y, 60, 'right');
				this.changePaintOpacity(true);
			}
			y += lineHeight;
			...
			if (item[NK].v4) {
				...
				this.drawText(item[NK].v4[2] + "/" + item[NK].v4[1], x * 1.7, y, 60, 'right');
				this.changePaintOpacity(true);
			}
			y += lineHeight;
			...
			if (item[NK].v5) {
				...
				this.drawText(item[NK].v5[2] + "/" + item[NK].v5[1], x * 1.7, y, 60, 'right');
				this.changePaintOpacity(true);
			}
